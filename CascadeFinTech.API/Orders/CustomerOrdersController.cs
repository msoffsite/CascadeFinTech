...
using CascadeFinTech.Application.Orders.ChangeCustomerOrder;
using CascadeFinTech.Application.Orders.GetCustomerOrderDetails;
using CascadeFinTech.Application.Orders.GetCustomerOrders;
using CascadeFinTech.Application.Orders.PlaceCustomerOrder;
using CascadeFinTech.Application.Orders.RemoveCustomerOrder;
...
namespace CascadeFinTech.API.Orders
{
    ...
    public class CustomerOrdersController : Controller
    {
        ...
        /// </summary>
        /// <param name="customerId">Customer ID.</param>
        /// <param name="request">Books list.</param>
        [Route("{customerId}/orders")]
        [HttpPost]
        ...
        {
           await _mediator.Send(new PlaceCustomerOrderCommand(customerId, request.Books, request.Currency));
        ...
        /// <param name="customerId">Customer ID.</param>
        /// <param name="orderId">Order ID.</param>
        /// <param name="request">List of books.</param>
        [Route("{customerId}/orders/{orderId}")]
        [HttpPut]
        ...
        public async Task<IActionResult> ChangeCustomerOrder(
            ...
            [FromBody]CustomerOrderRequest request)
        {
            await _mediator.Send(new ChangeCustomerOrderCommand(customerId, orderId, request.Books, request.Currency));
